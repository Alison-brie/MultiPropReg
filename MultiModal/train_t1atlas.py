...
parser = argparse.ArgumentParser("t2-to-t1atlas")
...
parser.add_argument('--save', type=str, default='model/MPR-Tr-MIND-SReg-Fdata-T1atlas', help='experiment name')
...
def main():
  ...
  # data generator
  data_dir = 'train/T2-norm-255'
  train_vol_names = glob.glob(os.path.join(data_dir, '*.nii.gz'))
  random.shuffle(train_vol_names)
  train_data = datagenerators.T1T2Dataset(train_vol_names, atlas_file='data/subject-4-T1.nii.gz')
